...
public class BrandRepositoryTests {
	...
	@Test
	public void testCreateBrandOne() {
	...
	@Test
	public void testCreateBrandTwo() {
	...
	@Test
	public void testCreateBrandThree() {
	...
	public void testGetById() {
		...
		assertEquals("Acer", brand.getName());
	}
	...
	public void testUpdateName() {
		...
		Brand savedBrand = repo.save(samsung);
		assertEquals(newName, savedBrand.getName());
